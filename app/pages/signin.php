...
if (!empty($_POST)) {
    ...
    if (empty($errors)) {
        ...
        $row = query($query, ['email' => $email], true);
        ...
        if ($row) {
            ...
            $errors['email'] = "Bu email ile kayıtlı kullanıcı bulunamadı";
        }
    }
}
?>
                        ...
                        <form method="post">
                            ...
                            <div class="d-flex align-items-center justify-content-between mb-4">
                                <div class="form-check">
                                    ...
                                    <label name="remember" class="form-check-label" for="exampleCheck1" value="1">Beni hatırla</label>
                                </div>

                            </div>
                            <button type="submit" class="btn btn-primary py-3 w-100 mb-4">Giriş Yap</button>
                            <p class="text-center mb-0">Hesabın yok mu? <a href="signup">Kayıt Ol</a></p>
                        </form> <!-- BURAYI EKLEDİK -->
                    </div>
                </div>
